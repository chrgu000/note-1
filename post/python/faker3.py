...
if __name__ == '__main__':
    ...
    if fileType == 'json':
        with open(file_path, 'w') as f:
            for i in range(num):
                data = {
                    'id' : fake.random_int(min=0, max=10),
                    'ltenc1rsrp' : fake.random_int(min=0, max=5),
                    'ltenc2rsrp' : fake.random_int(min=0, max=5),
                    'ltenc3rsrp' : fake.random_int(min=0, max=5),
                    'ltenc4rsrp' : fake.random_int(min=0, max=5),
                    'ltenc5rsrp' : fake.random_int(min=0, max=5),
                    'ltenc6rsrp' : fake.random_int(min=-5, max=5),
                    'ltescrsrp' : 8
                }
